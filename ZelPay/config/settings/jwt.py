...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "zelpaymant.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "zelpaymant.authentication.services.auth_jwt_response_payload_handler",
